          ...
          <div class="card card-carousel overflow-hidden h-100 p-0">
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100">
                ...
                <!-- FIX GAMBAR #1 -->
                <div class="carousel-item h-100 active" style="background-image: url('<?= base_url('img/carousel-1.jpg') ?>'); background-size: cover;">
                ...
                <!-- FIX GAMBAR #2 -->
                <div class="carousel-item h-100" style="background-image: url('<?= base_url('img/carousel-2.jpg') ?>'); background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                ...
                <!-- FIX GAMBAR #3 -->
                <div class="carousel-item h-100" style="background-image: url('<?= base_url('img/carousel-3.jpg') ?>'); background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
